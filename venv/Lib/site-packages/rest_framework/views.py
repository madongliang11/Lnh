...
class APIView(View):
    ...
    def check_permissions(self, request):
        ...
        for permission in self.get_permissions():
            # 如果has_permission返回True,表示通过权限认证
            # 如果has_permission返回Flase,执行permission_denied(),抛出异常，没有权限
    ...
    def check_throttles(self, request):
        ...
        for throttle in self.get_throttles():
            # 如果allow_request返回False,最终执行throttled（）方法，抛出异常
    ...
    def determine_version(self, request, *args, **kwargs):
        ...
        if self.versioning_class is None:
            return (None, None)
        # 处理版本类的对象，例如URLPathVersioning类对象
    ...
    def initialize_request(self, request, *args, **kwargs):
        ...
        return Request(
            ...
            # 封装所有认证对象
            authenticators=self.get_authenticators(),  # 返回的是一个列表，列表元素为实例化对象[]
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        # request(原生request，[BasicAuthentication(),])
